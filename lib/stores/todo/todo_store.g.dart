...
mixin _$TodoStore on TodoStoreBase, Store {
  Computed<bool>? _$isValidForUpdateComputed;

  @override
  bool get isValidForUpdate => (_$isValidForUpdateComputed ??= Computed<bool>(
          () => super.isValidForUpdate,
          name: 'TodoStoreBase.isValidForUpdate'))
      .value;
